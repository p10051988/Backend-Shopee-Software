...
RUNTIME_METRICS_DIR=${RUNTIME_METRICS_DIR:-logs/runtime-metrics}
RUNTIME_METRICS_RETENTION_DAYS=${RUNTIME_METRICS_RETENTION_DAYS:-90}
RUNTIME_METRICS_FLUSH_SECONDS=${RUNTIME_METRICS_FLUSH_SECONDS:-30}
EOF
